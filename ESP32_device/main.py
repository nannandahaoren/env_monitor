...
def main():
    global MQTT_CLIENT, LED, temp_array, dataset_temp, dataset_time,T, i2c
    ...
    while True:
        ...
        if len(temp_array) == 8:
            ...
            if length == 0:
                ...
                str_msg = str(derta_time)+','+str(round_number)
                
                
                # msg = struct.pack("f", round_number)
                msg = struct.pack("12s", str_msg.encode('utf-8'))
